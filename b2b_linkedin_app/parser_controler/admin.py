...
class ParserRequestAdmin(PaidPermissionAdmin):
    list_display = (
        'location', 'limit', 'start_page', 'end_page', 'created_at', 'status', 'start_parser_button'
    )
    ...
    def start_parser_button(self, obj):
        return format_html(
            ...
            f'{obj.pk}/start-parser/'
        )
    start_parser_button.short_description = 'Start Parsing'
    start_parser_button.allow_tags = True
